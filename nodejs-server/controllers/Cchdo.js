...
module.exports.findCCHDO = function findCCHDO (req, res, next, id, startDate, endDate, polygon, box, winding, center, radius, metadata, woceline, cchdo_cruise, source, compression, mostrecent, data, presRange, batchmeta) {
  ...
  Profiles.findCCHDO(res, id, startDate, endDate, polygon, box, winding, center, radius, metadata, woceline, cchdo_cruise, source, compression, mostrecent, data, presRange, batchmeta)
