...
module.exports.findtimeseries = function findtimeseries (req, res, next, id, startDate, endDate, polygon, box, winding, center, radius, compression, mostrecent, data, batchmeta, timeseriesName) {
  ...
  Timeseries.findtimeseries(res, timeseriesName, id, startDate, endDate, polygon, box, winding, center, radius, compression, mostrecent, data, batchmeta)
