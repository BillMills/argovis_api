...
module.exports.findTC = function findTC (req, res, next, id, startDate, endDate, polygon, multipolygon, box, winding, center, radius, metadata, name, mostrecent, compression, data, batchmeta) {
