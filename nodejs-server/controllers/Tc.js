...
module.exports.findTC = function findTC (req, res, next, id, startDate, endDate, polygon, box, winding, center, radius, metadata, name, mostrecent, compression, data, batchmeta) {
  ...
  Tc.findTC(res, id, startDate, endDate, polygon, box, winding, center, radius, metadata, name, mostrecent, compression, data, batchmeta)
