...
module.exports.drifterSearch = function drifterSearch (req, res, next, id, startDate, endDate, polygon, box, winding, center, radius, metadata, wmo, platform, compression, mostrecent, data, batchmeta) {

  apihits.apihits.create({metadata: req.openapi.openApiRoute, query: req.query, isWeb: req.headers.origin === 'https://argovis.colorado.edu'})

  Drifters.drifterSearch(res,id, startDate, endDate, polygon, box, winding, center, radius, metadata, wmo, platform, compression, mostrecent, data, batchmeta)
