 ...
 * returns List
 **/
exports.findCCHDO = function(id,startDate,endDate,polygon,box,center,radius,metadata,woceline,cchdo_cruise,source,compression,mostrecent,data,presRange,batchmeta) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = [ {
